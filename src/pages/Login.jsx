        ...
        <div className="w-full max-w-7xl bg-white border border-gray-200 flex overflow-hidden">
          ...
          <div className="flex-1 flex flex-col justify-center px-6 py-20 md:px-10 lg:px-16">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <i className="ri-contacts-book-3-line text-gray-400 text-xl"></i>
                  </div>
                  <input
                    type="text"
                    className="w-full border pl-11 pr-4 py-3.5 rounded-md border-gray-300 focus:ring focus:ring-blue-400 outline-none transition"
                    value={emailOrMobile}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border pl-11 pr-10 py-3.5 rounded-md border-gray-300 focus:ring focus:ring-blue-400 outline-none transition"
                    value={password}
                  ...
                  >
                    {showPassword ? (
                      <i className="ri-eye-line text-gray-500 text-xl"></i>
                    ) : (
              ...
              <button
                type="submit"
                className="cursor-pointer w-full bg-blue-600 text-white font-bold py-3 rounded-lg hover:bg-blue-700 transition shadow-md"
              >
                Login
              </button>
