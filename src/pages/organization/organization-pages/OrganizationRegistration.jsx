...
const OrganizationRegistration = () => {
  ...
  return (
    <div className="relative w-full h-full py-12 px-8">
      <img
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 z-10 relative">
        <div>
        ...
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <button
            type="button"
            onClick={handleReset}
            className="px-4 py-2 text-sm font-medium text-gray-700 bg-white rounded-md border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transition"
          >
            Reset
          </button>
          <button
      ...
      <div className="grid gap-8 relative z-10">
        ...
        <div>
          ...
          >
            ...
            <div className="bg-white p-6 sm:p-8 rounded-md border border-gray-200 space-y-6">
              {/* School Details */}
